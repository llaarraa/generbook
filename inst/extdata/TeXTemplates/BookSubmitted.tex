...
%\newcommand{\Afilliation}[1]{\small{#1}\par} %new line after afiliation
%\newcommand{\Afilliation}[1]{\small{#1}} %no new line after afiliation
%changed 2014, style of affiliation
...
%same e-mail style for both styles
\ifdefstring{\Style}{AS2011}{\newcommand{\Email}[1]{\texttt{\email{#1}}}}{\newcommand{\Email}[1]{\texttt{\email{#1}}}}
...
\renewcommand{\DocTitle}{\DocTitleSubmitted}
  \input{cover.tex}
~
\thispagestyle{empty}
\newpage
...
\thispagestyle{empty}
 \begin{center}
  \Large
   \begin{flushright}
   \vspace{17cm} {\Huge \em{ \textbf{\DocTitleSubmitted}}} \\ [0.5cm]
   \end{flushright}
   \normalsize
 \end{center}
